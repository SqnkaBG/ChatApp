...
export default function Settings() {
  return (
    <div className="flex h-screen w-screen flex-wrap bg-white">
      ...
      <div className="h-[100%] w-[100%] flex-col items-center justify-center bg-gradient-to-r from-blue-400 to-blue-600 md:w-[95.5%] overflow-y-auto ">
        <SearchBar />
        <div className="flex h-[93%] w-full flex-col   text-black pb-[1%]">
